...
static __INLINE uint32_t NVIC_GetPriority(IRQn_Type IRQn)
{
  ...
  if(IRQn < 0) {
   ...
   } else {                                            /* get priority for Cortex-M3 system interrupts */
...
#define SYSTICK_CLKSOURCE           2            /* Clocksource has the offset 2 in SysTick Control and   */
                                                 /* Status Register                                       */
...
{ 
  ...
  SysTick->CTRL = (1 << SYSTICK_CLKSOURCE) | (1<<SYSTICK_ENABLE) | (1<<SYSTICK_TICKINT);
                                                                       /* Enable SysTick IRQ and SysTick*/
                                                                       /* Timer                         */
