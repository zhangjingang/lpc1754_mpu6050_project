...
#define i2c_write   i2cwrite 	//realize by jgs => I2CINT.c
#define i2c_read    i2cread		//realize by jgs => I2CINT.c
#define delay_ms	BspDelayMS	//realize by jgs => bsp_timer.c
#define get_ms      get_ms		//realize by jgs => bsp_timer.c
